...
/*
  ...
  Provides a SECURITY DEFINER function that edge functions can call
  to create auth users + profiles for new interns, bypassing the
  auth.admin API which has restrictions in this environment.
*/
